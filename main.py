...
BOT_TOKEN = "5236548723:AAHLDyeGenqQv_QYeqEwnmnhfLTFL5knLl8"
PAYMENT_CHANNEL = "@paymentanonymous" #add payment channel here including the '@' sign
OWNER_ID = 1816704394 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@anonymousKHG"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
